...
function App() {
  ...
  // Se NÃO tiver nenhum perfil selecionado, mostra a tela dos 3 perfis definitivos
  if (!perfilAtivo) {
    return (
      <div className="telaPerfisGlobal">
        <div className="containerPerfisGlobal">
          ...
          <div className="gradePerfisGlobal">
            <div className="perfilGlobal" onClick={() => logarPerfil('Locky')}>
              <img src="https://upload.wikimedia.org/wikipedia/commons/0/0b/Netflix-avatar.png" alt="Locky" />
              <span>Locky</span>
            </div>
            ...
            <div className="perfilGlobal" onClick={() => logarPerfil('Amigo')}>
              <img src="https://i.pinimg.com/474x/64/e1/eb/64e1eb2d17dd18e2bf04fab75f913c85.jpg" alt="Amigo" />
              <span>Amigo</span>
            </div>
          </div>
          <button className="btnGerenciarGlobal">Gerenciar Perfis</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ backgroundColor: '#141414', minHeight: '100vh' }}>
      <Routes>
        <Route path='/' element={<CatalogoHome aoSair={deslogarPerfil} />} />
